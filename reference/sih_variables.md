...
#>  6 NASC      Data de nascimento (aaaammdd)                         char… pacien…
#>  7 SEXO      Sexo (0=Ignorado, 1=Masculino, 3=Feminino)            char… pacien…
#>  8 IDADE     Idade (valor numérico conforme COD_IDADE)             char… pacien…
...
#>   variable description                               type      section   
#>   <chr>    <chr>                                     <chr>     <chr>     
#> 1 IDADE    Idade (valor numérico conforme COD_IDADE) character paciente  
#> 2 VAL_SH   Valor dos serviços hospitalares           character financeiro
#> 3 VAL_SP   Valor dos serviços profissionais          character financeiro
#> 4 VAL_TOT  Valor total da AIH                        character financeiro
#> 5 VAL_UTI  Valor de UTI                              character financeiro
#> 6 US_TOT   Valor total dos procedimentos (US$)       character financeiro
```
