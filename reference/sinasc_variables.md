...
#>    <chr>     <chr>                                                 <chr> <chr>  
#>  1 DTNASC    Data de nascimento (ddmmaaaa)                         char… recem_…
...
#>  5 PESO      Peso ao nascer (gramas)                               char… recem_…
#>  6 APGAR1    Apgar no 1º minuto                                    char… recem_…
#>  7 APGAR5    Apgar no 5º minuto                                    char… recem_…
...
#> 10 IDADEMAE  Idade da mãe (anos)                                   char… materna
#> # ℹ 34 more rows
sinasc_variables(search = "mae")
#> # A tibble: 9 × 4
#>   variable   description                                           type  section
#>   <chr>      <chr>                                                 <chr> <chr>  
#> 1 IDADEMAE   Idade da mãe (anos)                                   char… materna
