...
The SI-PNI contains aggregated vaccination data: dose counts (DPNI) and
coverage rates (CPNI) per municipality, vaccine, and age group. Unlike
other DATASUS modules, data is in plain .DBF format and covers
1994–2019.
