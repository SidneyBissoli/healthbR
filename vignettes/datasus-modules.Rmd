---
title: "DATASUS Modules: SIM, SINASC, SIH, SIA, SINAN, CNES, and SI-PNI"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{DATASUS Modules: SIM, SINASC, SIH, SIA, SINAN, CNES, and SI-PNI}
...
The `healthbR` package provides access to seven DATASUS information systems via FTP, covering mortality, live births, hospital admissions, outpatient production, notifiable diseases, the health facility registry, and vaccination data:
...
| SI-PNI | `sipni_data()` | PNI (doses e cobertura) | Annual/UF | 1994--2019 |
...
The SI-PNI (Sistema de Informacao do Programa Nacional de Imunizacoes) contains **aggregated** vaccination data from the National Immunization Program. Unlike other DATASUS modules, SI-PNI files are plain .DBF (not DBC-compressed) and contain dose counts and coverage rates rather than individual-level microdata.
...
- SI-PNI is annual with plain .DBF files (one per type/UF/year). Data available 1994--2019 only.
