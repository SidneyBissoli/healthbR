---
title: "DATASUS Modules: SIM, SINASC, SIH, SIA, SINAN, and CNES"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{DATASUS Modules: SIM, SINASC, SIH, SIA, SINAN, and CNES}
...
The `healthbR` package provides access to six DATASUS information systems via FTP, covering mortality, live births, hospital admissions, outpatient production, notifiable diseases, and the health facility registry:
...
The same pattern works for `sinasc_*()`, `sih_*()`, `sia_*()`, `sinan_*()`, and `cnes_*()`.
