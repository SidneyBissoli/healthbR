...
The package currently supports **12 data sources** organized in two groups:
...
coverage rates (CPNI) per municipality, vaccine, and age group. Unlike other
DATASUS modules, data is in plain .DBF format and covers 1994--2019.
